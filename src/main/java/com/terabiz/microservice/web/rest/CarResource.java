...
import com.terabiz.microservice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.terabiz.microservice.domain.Car}.
 */
@RestController
@RequestMapping("/api")
public class CarResource {
    ...
    private static final String ENTITY_NAME = "microserviceCar";
